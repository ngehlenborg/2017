...
Please see the problems proposed for the Design Contest as well as the accepted submissions below:

1. [Call of Participation](#cfp)
1. [Accepted Submissions](#csub)

<h2 id="cfp">Call of Participation</h2>
...
Two scenarios were provided to contests for **Mammography** and **Down Syndrome** screening
...
<h2 id="csub">Contest Submissions</h2>
...
**Accepted Submission**
<div class="sumDetail"> Christian Stolte, <i>New York Genome Center</i></div>
...
**Accepted Submission**
<div class="sumDetail" >Hamid Younesy (presented by Torsten Möller), <i>Simon Fraser University</i></div>

<a href ="{{ site.baseurl}}/files/hamid-tree-solution.png"> <img style="padding-right: 10px;" src="{{ site.baseurl }}/files/hamid-tree-solution.png" alt="hamid-ds" height="350" width="475"></a>
